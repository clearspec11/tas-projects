...
function rowToProject(r: Record<string, unknown>): Project {
	return {
		...
		original_budget: r.original_budget != null ? Number(r.original_budget) : undefined,
		lat: Number(r.lat),
		lng: Number(r.lng),
		...
		budget_history: (r.budget_history as Project['budget_history']) ?? undefined,
		last_verified: (r.last_verified as string) ?? undefined,
